...
Open [http://127.0.0.1:7410](http://127.0.0.1:7410). The backend uses `127.0.0.1:8766`. Port `8080` is not the OfferU web UI; it is reserved for the optional local llama.cpp provider endpoint and should not be opened in a browser.
