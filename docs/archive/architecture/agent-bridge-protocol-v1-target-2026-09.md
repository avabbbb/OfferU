> **HISTORICAL SNAPSHOT** — archived from docs/architecture/agent-bridge-protocol.md on 2026-09-23. Current authority lives in ARCHITECTURE.md and docs/architecture/agent-system.md.
