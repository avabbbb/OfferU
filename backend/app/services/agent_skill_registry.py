...
_SKILLS = (
    ...
    _skill("application_assistant", "投递助手", "applications", "partial", "起草投递材料、预演站外动作并登记待办；外部写入永远停在 OfferU Proposal/HITL。", "skill_assistant", ("get_profile", "list_jobs", "get_job", "get_pre_application_state", "list_resumes", "get_resume", "list_applications", "get_application_workspace", "preview_application_action", "list_career_artifacts", "get_career_artifact", "generate_cover_letter", "save_career_artifact", "create_application", "update_application_record"), featured=True, order=110, missing=("ApplicationActionConnector 外部执行器",), aliases=("apply", "投递")),
